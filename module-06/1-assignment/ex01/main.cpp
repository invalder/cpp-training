...
int main( void ) {
	...
	Data		*test = Serializer::TestingChain( serialized );

	std::cout << "----------------------------------------" << std::endl;

	std::cout << "deserialized->n: " << test->n << std::endl;
	std::cout << "deserialized->c: " << test->c << std::endl;
	std::cout << "deserialized->b: " << test->b << std::endl;
	std::cout << "deserialized->s: " << test->s << std::endl;
